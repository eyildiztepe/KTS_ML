...
XGBoost, yüksek tahmin etme gücüne sahip olup, diğer algoritmalardan 10 kata kadar daha hızlıdır. Ayrıca XGBoost, genel performansı iyileştiren ve aşırı uyum ya da aşırı öğrenmeyi azaltan bir dizi düzeltme işlemleri içermektedir [@yangin2019xgboost].   
