...
```{r echo=FALSE,fig.align="center",fig.cap="Yapay Sinir Ağları Modeli Karmaşıklık Matrisi",out.width="105%",out.height="60%"}
knitr::include_graphics(path="figure/nn_conf.png")
```
```{r echo=FALSE,fig.align="center",fig.cap="Yapay Sinir Ağları Modeli ROC Eğrisi ve AUC Değeri",out.width="105%",out.height="60%"}
...
### Neural Network (Yapay Sinir Ağları)  Modeli
