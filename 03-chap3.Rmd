...
Uygulamada Python programlama dili  ve Scikit-Learn, Pandas, Numpy, Matplotlib, XGBoost kütüphanelerinden yararlanılmıştır. Kullanılan kodlar ve veri seti açık kaynaklı olacak şekilde [KTS_ML](https://github.com/eyildiztepe/KTS_ML) adı altında github deposunda paylaşılmaktadır.
