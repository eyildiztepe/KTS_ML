...
```{python echo=FALSE}
#print(f'En İyi Parametreler : {GSC.best_params_}')
print("En İyi Parametreler:{'booster':'gbtree2,'eta':0.1,'max_depth':3,'min_child_weight':\n10,'n_estimators':100,'objective':'multi:softprob','sumsample':0.5}")
```
GridSearchCV algoritması ile bulduğumuz parametrelerle kurulan modelimizin sınıflandırma metrikleri.
```{python echo=FALSE}
...
print("En İyi Parametreler:{'activation':'relu','hidden_layer_sizes':19,'learning_rate':'adaptive'}")
```
GridSearchCV algoritması ile bulduğumuz parametrelerle kurulan modelimizin sınıflandırma metrikleri.
```{python echo=FALSE}
...
```{r echo=FALSE,fig.align="center",fig.cap="Sinir Ağları Modeli Karmaşıklık Matrisi",out.width="105%",out.height="60%"}
knitr::include_graphics(path="figure/nn_conf.png")
```
```{r echo=FALSE,fig.align="center",fig.cap="Sinir Ağları Modeli ROC Eğrisi ve AUC Değeri",out.width="105%",out.height="60%"}
...
```{python echo=FALSE}
#print(f'En İyi Parametreler : {GSC.best_params_}')
print("En İyi Parametreler:{'algorithm':'auto','n_neighbors':23,'weights':'uniform'}")
...
```{python echo=FALSE}
#print(f'En İyi Parametreler : {GSC.best_params_}')
print("En İyi Parametreler:{'ccp_alpha': 0.01, 'max_features': 'auto', 'max_samples': 10, 'n_estimators': 400}")
...
```{python echo=FALSE}
#print(f'En İyi Parametreler : {GSC.best_params_}')
print("En İyi Parametreler:{'eta': 0.2, 'max_depth': 10, 'min_child_weight': 10, 'n_estimators': 400}")
```
#### En İyi Parametreli Model  
...
```
```{r echo=FALSE,fig.align="center",fig.cap="XGBoost Modeli Karmaşıklık Matrisi",out.width="105%",out.height="60%"}
knitr::include_graphics(path="figure/XGB_bin_conf.png")
```
```{r echo=FALSE,fig.align="center",fig.cap="XGBoost Modeli ROC Eğrisi ve AUC Değeri",out.width="105%",out.height="60%"}
knitr::include_graphics(path="figure/XGBClassifier_binary_roc.png")
```  


### Neural Network (Sinir Ağları)  Modeli
...
roc_bin(NN_modelbin)
```
```{r echo=FALSE,fig.align="center",fig.cap="Yapar Sinir Ağları Modeli Karmaşıklık Matrisi",out.width="105%",out.height="60%"}
knitr::include_graphics(path="figure/nn_bin_conf.png")
```
```{r echo=FALSE,fig.align="center",fig.cap="Yapar Sinir Ağları Modeli ROC Eğrisi ve AUC Değeri",out.width="105%",out.height="60%"}
