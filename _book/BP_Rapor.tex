...
Uygulamada Python programlama dili ve Scikit-Learn, Pandas, Numpy, Matplotlib, XGBoost kütüphanelerinden yararlanılmıştır. Kullanılan kodlar ve veri seti açık kaynaklı olacak şekilde \href{https://github.com/eyildiztepe/KTS_ML}{KTS\_ML} adı altında github deposunda paylaşılmaktadır.
...
\begin{verbatim}
        ...
        Mild       0.79      0.83      0.81       153
     Mod+Sev       0.83      0.79      0.81       159
...
\end{verbatim}
\begin{verbatim}
Balanced Accuracy Score : 0.8112590948329017
\end{verbatim}
\begin{figure}
