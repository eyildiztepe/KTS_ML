...
\begin{verbatim}
<matplotlib.legend.Legend object at 0x000000008797D790>
\end{verbatim}
\begin{figure}
...
\end{figure}
\hypertarget{neural-networks-yapay-sinir-aux11flarux131}{%
\subsection{Neural Networks (Yapay Sinir Ağları)}\label{neural-networks-yapay-sinir-aux11flarux131}}
...
\end{verbatim}
\begin{verbatim}
<matplotlib.legend.Legend object at 0x000000000C3F9520>
\end{verbatim}
\begin{figure}
...
\caption{Yapay Sinir Ağları Modeli Karmaşıklık Matrisi}\label{fig:unnamed-chunk-42}
\end{figure}
\begin{figure}
...
\caption{Yapay Sinir Ağları Modeli ROC Eğrisi ve AUC Değeri}\label{fig:unnamed-chunk-43}
\end{figure}
...
\end{verbatim}
\begin{verbatim}
Balanced Accuracy Score : 0.8181650018497966
\end{verbatim}
\begin{figure}
