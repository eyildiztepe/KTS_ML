...
\CommentTok{\#params = \{"n\_neighbors":np.arange(5,200,1),}
\CommentTok{\#          "weights":["uniform", "distance"],}
\CommentTok{\#          "algorithm":["auto","ball\_tree","kd\_tree","brute"]\}}
\CommentTok{\#GSC = GridSearchCV(KNN\_model,param\_grid=params,}
                   \CommentTok{\#cv=10,verbose=1,scoring="accuracy").fit(X\_train,y\_train)}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
