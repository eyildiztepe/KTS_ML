...
\begin{verbatim}
<matplotlib.legend.Legend object at 0x00000000879AC760>
\end{verbatim}
\begin{figure}
...
\end{verbatim}
\begin{verbatim}
<matplotlib.legend.Legend object at 0x000000000E4BE2B0>
\end{verbatim}
\begin{figure}
...
\caption{Yapar Sinir Ağları Modeli Karmaşıklık Matrisi}\label{fig:unnamed-chunk-59}
\end{figure}
\begin{figure}
...
\caption{Yapar Sinir Ağları Modeli ROC Eğrisi ve AUC Değeri}\label{fig:unnamed-chunk-60}
\end{figure}
\hypertarget{Bolum4}{%
