...
\bottomrule
\end{longtable}
\hypertarget{uxe7ok-sux131nux131flux131multiclass-sux131nux131flama-problemi}{%
\section{Çok Sınıflı(Multiclass) Sınıflama Problemi}\label{uxe7ok-sux131nux131flux131multiclass-sux131nux131flama-problemi}}
...
\begin{verbatim}
<matplotlib.legend.Legend object at 0x0000000087A6A760>
\end{verbatim}
\begin{figure}
...
Daha önce belirlediğimiz parametre uzayını ve Scikit-Learn kütüphanesinde bulunan GridSearchCV algoritması ile en uygun doğruluk oranını yakalayana kadar çalışması sağlandı.
\begin{verbatim}
Text(0, 0.5, 'Eğitim Verisi Doğruluk Skoru (%)')
\end{verbatim}
\begin{figure}
...
\end{figure}
\begin{verbatim}
En İyi Parametreler:{'booster':'gbtree2,'eta':0.1,'max_depth':3,'min_child_weight':
10,'n_estimators':100,'objective':'multi:softprob','sumsample':0.5}
\end{verbatim}
GridSearchCV algoritması ile bulduğumuz parametrelerle kurulan modelimizin sınıflandırma metrikleri.
\begin{verbatim}
              precision    recall  f1-score   support
...
\caption{Rassal Ormanlar Modeli Karmaşıklık Matrisi}\label{fig:unnamed-chunk-34}
\end{figure}
\begin{figure}
...
\caption{Rassal Ormanlar Modeli ROC Eğrisi ve AUC Değeri}\label{fig:unnamed-chunk-35}
\end{figure}
\hypertarget{neural-networks-sinir-aux11flarux131}{%
\subsection{Neural Networks (Sinir Ağları)}\label{neural-networks-sinir-aux11flarux131}}

Bu bölümde veri setimiz üzerinde Neural Networks modelini kullanacak ve çıktılarını değerlendireceğiz.
...
\end{verbatim}
\begin{verbatim}
<matplotlib.legend.Legend object at 0x000000000B42A520>
\end{verbatim}
\begin{figure}
...
\end{figure}
\hypertarget{iki-sux131nux131flux131-sux131nux131flama}{%
\section{İki Sınıflı Sınıflama}\label{iki-sux131nux131flux131-sux131nux131flama}}

Bu bölümde orijinal hali 3. Sınıftan oluşan ilk verimizde orta ve ağır ciddiyet sınıflandırmasına sahip olan gözlemler birleştirilerek sadece iki sınıflı bir sınıflama problemi yapılmıştır.\\
Verimiz \%70'e \%30 oranında Eğitim ve Test verisi olarak ayrılmıştır.
...
\end{verbatim}
\begin{verbatim}
<string>:4: RuntimeWarning: More than 20 figures have been opened. Figures created through the pyplot interface (`matplotlib.pyplot.figure`) are retained until explicitly closed and may consume too much memory. (To control this warning, see the rcParam `figure.max_open_warning`).
\end{verbatim}
\begin{figure}
...
\end{figure}
\hypertarget{neural-network-sinir-aux11flarux131-modeli}{%
\subsection{Neural Network (Sinir Ağları) Modeli}\label{neural-network-sinir-aux11flarux131-modeli}}

Bu bölümde veri setimiz üzerinde yapar sinir ağları modelini kullanacak ve çıktılarını değerlendireceğiz.
