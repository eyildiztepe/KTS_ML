...
\AbstractTR{
Bu projemizde, karpal tünel hastalığının Epidemiyolojisi, Etiyolojisi, Semptomlarından bahsedilmiş ve tanı değerlendirilmesi yapılmıştır.
...
\strut \\
\textbf{Anahtar Kelimeler:} Makine Öğrenmesi, Sınıflandırma, Karpal Tünel Sendromu, XGBoost, Yapay Sinir Ağları
}

\Abstract{
In this project, the Epidemiology, Etiology and Symptoms of carpal tunnel disease were mentioned and the diagnosis was evaluated.
...
\strut \\
\textbf{Keywords:} Machine Learning, Classification, Karpal Tunnel Syndrome, XGBoost, Artificial Neural Networks
}
...
Makine öğrenmesi yöntemleri günümüzde hastalıkların belirlenmesinde ve sınıflandırmasında yaygın olarak kullanılmaktadır. Hastalığı belirlemede ve sınıflandırmada kullanılan makine öğrenmesi modelleri ne yazık ki eğitim verisine ihtiyaç duymaktadır. Günümüz yaşam koşullarında çalışma hayatı genellikle ofiste ve bilgisayar başında geçmektedir. Bu tarz işlerin yaygınlaşıp popüler hale gelmesi ile birlikte karpal tünel sendromunun (KTS) görülme sıklığı ciddi oranda artmıştır.
...
Karpal tünel sendromu, medyan sinirin karpal tüneli içerisinde baskıya uğraması sonucu ortaya çıkan semptomların genel adıdır. Karpal tünel sendromunun görülme sıkılığı kadınlarda \%3-\%3.4 arasında iken erkeklerde \%0.6-\%2.7 arasında olarak belirlenmiş ve genelde baskın elde semptomlara rastlanmıştır. Her ne kadar görülme sıklıkları cinsiyetler bazında farklı olsa bile gözlenme sıklığı yaş ile doğru orantılıdır ve özellikle 20li ile 50li yaşlar arasında görülür.
...
\begin{verbatim}
        ...
        Mild       0.77      0.86      0.81       153
     Mod+Sev       0.85      0.75      0.80       159
...
\end{verbatim}
\begin{verbatim}
Balanced Accuracy Score : 0.8055863854975953
\end{verbatim}
\begin{figure}
...
Bu çalışmanın sürdürebilmesi için, uzman bir nörolog hekim tarafından daha fazla hastadan veri toplanabilir ve bu veriler kurulan modele katılarak model iyileştirebilir. Bunun yanı sıra 2021 yılında Japonya'da karpal tünel sendromunu mobil uygulama ile tespit etmek için geliştirilmiş ve geliştirilmeye devam eden projeye (Koyama ve diğerleri, 2021) katkı sağlamak amacı ile elde olan veriler ve model parametreleri paylaşılabilir.
