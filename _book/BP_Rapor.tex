...
\title{PROJE BAŞLIĞI}
%\author{Yazar1 Ad SoyadYazar2 Ad Soyad} %Tek yazar için
\author{Yazar1 Ad Soyad \\ Yazar2 Ad Soyad} %Çok yazar için
...
\AbstractTR{
Ã--zet, Ã§alÄ±ÅŸmanÄ±n Ã¶nemini ve faydasÄ±nÄ± anlatan bir bÃ¶lÃ¼m degildir. Ã‡alÄ±smayÄ± ana
hatlarÄ±yla anlatacak ve 300 kelimeyi asmayacak sekilde hazÄ±rlanmalÄ±dÄ±r. En az Ã¼Ã§ en
Ã§ok beÅŸ anahtar kelime ilgili yere yazÄ±lmalÄ±dÄ±r.

\par

ikinci paragraf buradan baÅŸlar\\
~\\
...
\hypertarget{kts-tanim}{%
\chapter{Karpal Tünel Sendromu}\label{kts-tanim}}
...
\CommentTok{\#pkg \textless{}{-} c("dplyr", "ggplot2", "knitr", "bookdown", "devtools")}
\NormalTok{pkg }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"tidyverse"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }\StringTok{"bookdown"}\NormalTok{, }\StringTok{"devtools"}\NormalTok{)}
...
\CommentTok{\# the template files for the thesis.}
 \ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(devtools)) }\FunctionTok{install.packages}\NormalTok{(}\StringTok{"devtools"}\NormalTok{, }\AttributeTok{repos =} \StringTok{"http://cran.rstudio.com"}\NormalTok{)}
 \ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(thesisdown))devtools}\SpecialCharTok{::}\FunctionTok{install\_github}\NormalTok{(}\StringTok{"ismayc/thesisdown"}\NormalTok{)}
 \FunctionTok{library}\NormalTok{(thesisdown)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  devtools}\SpecialCharTok{::}\FunctionTok{install\_github}\NormalTok{(}\StringTok{"ismayc/thesisdown"}\NormalTok{)}
\NormalTok{  \}}
\FunctionTok{library}\NormalTok{(thesisdown)}
\NormalTok{flights }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"data/flights.csv"}\NormalTok{)}
\end{Highlighting}
