...
\textbf{Keywords:} Karpal Tunnel Syndrome, Multiclass Classification, Binary Classification, XGBoost, Artificial Neural Networks
}
...
XGBoost, yüksek tahmin etme gücüne sahip olup, diğer algoritmalardan 10 kata kadar daha hızlıdır. Ayrıca XGBoost, genel performansı iyileştiren ve aşırı uyum ya da aşırı öğrenmeyi azaltan bir dizi düzeltme işlemleri içermektedir (Yangın, 2019).
...
\hypertarget{refs}{}
\begin{CSLReferences}
\hspace{0.5cm} \leavevmode\vadjust pre{\hypertarget{ref-ardakani2020diagnosis}{}}%
